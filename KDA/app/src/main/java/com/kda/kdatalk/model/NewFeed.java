...
public class NewFeed {
    ...
    public NewFeed(String id, String content, String user_name, String user_url, ArrayList<String> list_image, String create_at, int num_like, int num_comment, boolean isLike) {
        this.id = id;
        this.content = content;
        this.user_name = user_name;
        this.user_url = user_url;
